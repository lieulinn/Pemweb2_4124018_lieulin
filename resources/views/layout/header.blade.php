        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="nav06">
            <ul class="navbar-nav mt-3 mt-lg-0 mb-3 mb-lg-0 ms-lg-3">
              <li class="nav-item me-4"><a class="nav-link" href="#">Tentang</a></li>
              <li class="nav-item me-4"><a class="nav-link" href="#">Perusahaan</a></li>
              <li class="nav-item me-4"><a class="nav-link" href="#">Layanan</a></li>
