 ...
 <section class="pb-5 bg-light"><div class="container pt-5">
          <div class="row align-items-center mb-5">
            <div class="col-12 col-md-10 col-lg-5 mb-5 mb-lg-0">
              <h2 class="display-4 fw-bold mb-5">Tingkatkan performa Anda setiap hari.</h2>
              <p class="lead text-muted mb-5">Bangun merek yang menarik dan disukai semua orang. Kembangkan sumber daya secara terus-menerus dan integrasikan dengan proyek sebelumnya.</p>
              <div class="d-flex flex-wrap"><a class="btn btn-primary me-2 mb-2 mb-sm-0" href="#">Lacak performa Anda</a><a class="btn btn-outline-secondary mb-2 mb-sm-0" href="#">Pelajari lebih lanjut</a></div>
            </div>
