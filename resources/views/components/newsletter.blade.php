        ...
        <div class="container text-center">
          <div class="row justify-content-center">
            <div class="col-12 col-lg-10 col-xl-8">
              ...
              <span class="text-muted">Buletin</span>
              <h2 class="display-4 fw-bold mt-2 mb-3">Berlangganan Buletin Kami</h2>
              <p class="lead text-muted mb-5">Dapatkan informasi terbaru dan penawaran eksklusif langsung di kotak masuk Anda.</p>
              <form action="#">
                <div class="row justify-content-center">
                  ...
                  <div class="col-12 col-md-8 col-lg-5 mb-3 mb-lg-0">
                    <input class="form-control" type="name" placeholder="Nama Anda">
                  </div>
                  <div class="col-12 col-md-8 col-lg-2">
                    <button class="btn btn-primary w-100">Berlangganan</button>
                  </div>
                </div>
              </form>
            </div>
